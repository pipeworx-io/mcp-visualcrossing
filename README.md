...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/weather_timeline \
  -H 'Content-Type: application/json' \
  -d '{"location":"Paris","start_date":"2023-07-04"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/weather_timeline`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
